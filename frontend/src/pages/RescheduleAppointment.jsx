...
const RescheduleAppointment = () => {
  ...
  const [formData, setFormData] = useState({
    member_id: '', doctor_id: '', slot_id: '', appointment_id: id
  });
    ...
    <>
      ...
      <div className="container mx-auto pt-20 px-4">
        <div className="bg-white rounded-2xl shadow-xl max-w-4xl w-full mx-auto p-10">
          <h2 className="text-2xl font-bold text-center mb-6">Reschedule Appointment</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="text-center mt-5">
              <button type="submit" className="bg-blue-600 text-white py-3 px-10 rounded-lg font-bold hover:bg-blue-700">Reschedule</button>
            </div>
          </form>
        </div>
      </div>
