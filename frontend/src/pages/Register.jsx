    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-xl max-w-4xl w-full overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-blue-500 text-white text-center py-6">
          ...
          <p className="text-sm">Create your account to manage your family's healthcare needs</p>
        </div>
        <div className="p-10">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <textarea name="address" onChange={handleChange} placeholder="Address *" className="w-full p-3 rounded-lg border border-gray-300 outline-none" required />
            </div>
            <div className="mb-4">
            ...
            <div className="text-center mt-5">
              <button type="submit" className="bg-blue-600 text-white py-3 px-10 rounded-lg font-bold hover:bg-blue-700">Register & Generate ID</button>
            </div>
          </form>
        </div>
      </div>
