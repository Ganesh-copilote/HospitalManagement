...
const doctorMenuItems = [
  ...
  { 
    ...
    icon: Users, 
    children: [
      { name: 'All Patients', icon: Users, path: '/doctor_patients' },
    //   { name: 'Patient Records', icon: FileText, path: '/doctor_patient_records' },
    ]
  },
  { name: 'Appointments', icon: Calendar, path: '/doctor_appointments' },
  { name: 'Medical Records', icon: ClipboardList, path: '/doctor_medical_records' },
  { name: 'Prescriptions', icon: Pill, path: '/doctor_prescriptions' },
  { name: 'Schedule', icon: Clock, path: '/doctor_schedule' },
//   { name: 'Consultation', icon: Stethoscope, path: '/doctor_consultation' },
//   { name: 'Settings', icon: Settings, path: '/doctor_settings' },
];

const DoctorSidebar = ({ isOpen, onClose, isDark, onThemeToggle }) => {
